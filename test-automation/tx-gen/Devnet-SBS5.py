...
tx_gen.set_config({
    "AMT_PER_TXN": [1e20, 1e20], #nano transfer # The random range for each transaction in the transaction-generation
...
if __name__ == "__main__":
    ...
    print(report)
    assert report["received-transaction-report"]["successful-transactions-total"] == 0
    assert report["received-transaction-report"]["failed-transactions-total"] == 1